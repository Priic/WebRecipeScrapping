package com.RecipeFoodCategory;
	...
	public class Vegan_Lunch  extends InitClass {

		@Test

		public void veganLunchRecipe() throws InterruptedException, IOException {
			...
			driver.findElement(By.id("ctl00_txtsearch")).sendKeys("vegan lunch");
			...
			// ---------------creating excel -------------------------------------------
						...
						xlUtil.createExcel("Vegan lunch");
			...
			for (Object each_recipe : link) {
				...
				xlUtil.setCellData("Vegan lunch", counter, 10, URLString);
				...
				xlUtil.setCellData("Vegan lunch", counter, 0, recipe_id);
				...
				xlUtil.setCellData("Vegan lunch", counter, 1, recipe_name);

				// Hardcoding recipe category value = lunch in all rows
				xlUtil.setCellData("Vegan", counter, 2, "lunch");
				...
				xlUtil.setCellData("Vegan lunch", counter, 4, ingredients);
				...
				xlUtil.setCellData("Vegan lunch", counter, 5, prep_Time);
				...
				xlUtil.setCellData("Vegan lunch", counter, 6, cook_Time);
				...
				xlUtil.setCellData("Vegan lunch", counter, 7, method);
				...
				xlUtil.setCellData("Vegan lunch", counter, 8, nutrientValue);

				// Hardcoding recipe category value = Snacks in all rows
				xlUtil.setCellData("Vegan lunch", counter, 9, "N/A");
