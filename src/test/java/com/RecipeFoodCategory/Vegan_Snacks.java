package com.RecipeFoodCategory;
	...
	public class Vegan_Snacks  extends InitClass {

		@Test

		public void veganSeganSnacksRecipe() throws InterruptedException, IOException {
			...
			driver.findElement(By.id("ctl00_txtsearch")).sendKeys("Vegan");
			...
			for (Object each_recipe : link) {
				...
				xlUtil.setCellData("Vegan", counter, 10, URLString);
				...
				xlUtil.setCellData("Vegan", counter, 0, recipe_id);
				...
				xlUtil.setCellData("Vegan", counter, 1, recipe_name);

				// Hardcoding recipe category value = Snacks in all rows
				xlUtil.setCellData("Vegan", counter, 2, "Snacks");

				// Hardcoding food category value = Veg
				xlUtil.setCellData("Vegan", counter, 3, "Veg");
				...
				xlUtil.setCellData("Vegan", counter, 4, ingredients);
				...
				xlUtil.setCellData("Vegan", counter, 5, prep_Time);
				...
				xlUtil.setCellData("Vegan", counter, 6, cook_Time);
				...
				xlUtil.setCellData("Vegan", counter, 7, method);
				...
				xlUtil.setCellData("Vegan", counter, 8, nutrientValue);

				// Hardcoding recipe category value = Snacks in all rows
				xlUtil.setCellData("Vegan", counter, 9, "N/A");
